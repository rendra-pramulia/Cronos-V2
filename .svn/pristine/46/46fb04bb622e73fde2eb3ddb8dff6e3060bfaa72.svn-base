...
QueryBuilder.OPERATORS = {
    ...
    is_today:                               { type: 'is_today',                             nb_inputs: 0, multiple: false, apply_to: ['datetime'] },
    less_than_x_days:                       { type: 'less_than_x_days',                     nb_inputs: 0, multiple: false, apply_to: ['datetime'] },
    less_than_or_equal_to_x_days:           { type: 'less_than_or_equal_to_x_days',         nb_inputs: 0, multiple: false, apply_to: ['datetime'] },
    greater_than_x_days_ago:                { type: 'greater_than_x_days_ago',              nb_inputs: 0, multiple: false, apply_to: ['datetime'] },
    greater_than_or_equal_to_x_days_ago:    { type: 'greater_than_or_equal_to_x_days_ago',  nb_inputs: 0, multiple: false, apply_to: ['datetime'] }
};
...
QueryBuilder.DEFAULTS = {
    ...
    operators: [
        ...
        'is_today',
        'less_than_x_days',
        'less_than_or_equal_to_x_days',
        'greater_than_x_days_ago',
        'greater_than_or_equal_to_x_days_ago'
    ],
...
QueryBuilder.defaults({
    mongoOperators: {
        ...
        is_not_null:      function(v) { return { '$ne': null }; },
            ...
            is_today:                               function(v){ ''; },
            less_than_x_days:                       function(v){ return {'$dlt': v[0]}; },
            less_than_or_equal_to_x_days:           function(v){ return {'$dlte': v[0]}; },
            greater_than_x_days_ago:                function(v){ return {'$dgt': v[0]}; },
            greater_than_or_equal_to_x_days_ago:    function(v){ return {'$dgte': v[0]}; }
    },
    ...
    mongoRuleOperators: {
        ...
        $gte: function(v) { return { 'val': v.$gte, 'op': 'greater_or_equal' }; },
        	...
        	//by rendra
            $dlt :     function(v) { return {'val': v.$dlt, 'op': 'less_than_x_days'}; },
            $dlte :    function(v) { return {'val': v.$dlte, 'op': 'less_than_or_equal_to_x_days'}; },
            $dgt :     function(v) { return {'val': v.$dgt, 'op': 'greater_than_x_days_ago'}; },
            $dgte :    function(v) { return {'val': v.$dgte, 'op': 'greater_than_or_equal_to_x_days_ago'}; }
    }
});
...
QueryBuilder.defaults({
    ...
    sqlOperators: {
        ...
        is_not_null:      { op: 'IS NOT NULL' },
            ...
            is_today:                               { op: '= \'\'' },
            less_than_x_days:                       { op: '< ?' },
            less_than_or_equal_to_x_days:           { op: '<= ?' },
            greater_than_x_days_ago:                { op: '> ?' },
            greater_than_or_equal_to_x_days_ago:    { op: '>= ?' }
    },
...
QueryBuilder.regional['en'] = {
  ...
  "operators": {
    ...
    "is_not_null": "is not null",
                "is_today": "is today",
                "less_than_x_days": "less than x days",
                "less_than_or_equal_to_x_days": "less than or equal to x days",
                "greater_than_x_days_ago": "greater than x days ago",
                "greater_than_or_equal_to_x_days_ago": "greater than or equal to x days ago"
  },
  "errors": {
