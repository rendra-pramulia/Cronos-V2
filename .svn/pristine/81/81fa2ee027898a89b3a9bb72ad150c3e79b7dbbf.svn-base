    ...
    function maintenanceController($scope, $q, $state, $uibModal, $rootScope, loginCheck, $stateParams, $uibModalStack, ajax, cronosToastr) {
      ...
      $scope.deleteRole = false;
        ...
        $scope.dtConfig = {
            ...
            "columns": [
                { "title": "Module Name", "data":  "moduleName", "className": "text-left", "defaultContent": "-"},
                { "title": "Description", "data":  "moduleDescription", "className": "text-left", "defaultContent": "-"},
                { "title": "Category", "data":  "category", "className": "text-left", "defaultContent": "-"},
                { "title": "Version", "data":  "version", "className": "text-left", "defaultContent": "-"},
                { "title": "Install Date", "data":  "installedDate", "className": "text-left", "defaultContent": "-"},
        ...
        var modalPatch = function(){
            ...
            var modalInstance = $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'app/pages/maintenance/masterModule/patchProcess.html',
                size: 'lg',
                scope: modalScope
            }).closed.then(function(){
               alert('modal closed');
        ...
        var modalService = function(){
            ...
            var modalInstance = $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'app/pages/maintenance/masterModule/restartService.html',
                size: 'lg',
                scope: modalScope
            }).closed.then(function(){
               alert('modal closed');
